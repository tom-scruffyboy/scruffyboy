...
- [x] **BRANCH BATCH (Tom: "cover a wide array of topics without saturating") — 12 more across 6 NEW categories, set now at 34.**
  Coat types: curly (cockapoos/doodles, the Moose tie-in) · double · short. Life stages: older dog · new rescue. Adventure: running · road trips. Weather: hot-weather safety (heatstroke signs, careful) · rainy-day walks. Education: what a waterless wash is (honest explainer, our bias disclosed on-page — key pre-launch product education) · dog-hates-baths rebuild · how to choose a groomer.
